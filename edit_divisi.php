      ...
      <?php include "sidebaradmin.php" ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
              <h1 class="page-title"> <i class="sidebar-item-icon fa fa-id-card-o";></i> Edit Divisi</h1>
                <ol class="breadcrumb">
                    
                    <li class="breadcrumb-item">Beranda > Divisi > <a href="edit_divisi.php" style="color: #0c2496;">Edit Divisi</a> </li>
                </ol>
                <div class="box">
                    <div class="container">
                      <!--<form>
            ...
            <div class="page-content fade-in-up">
               ...
               <!-- <input type="text" class="form-control form-control-lg form-control-borderless" name="x" placeholder="Cari Judul Informasi">
                ...
                <div class="ibox ibox-primary">
                            <div class="ibox-head">
                                <div class="ibox-title">Edit Divisi</div>
