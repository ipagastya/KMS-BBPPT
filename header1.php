  ...
  <!-- navbar-->
    <header class="header" >
      <div role="navigation" class="navbar navbar-default"  style="background-color: #466B97; border-color: #466B97; border-radius: 0px;">
        <div>
          <div class="navbar-header"><a href="index.php" class="navbar-brand"><img src="src/image/logokms.png" style="width: 200px; height: 45px;"></a>
          ...
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              <li><a href="informasi.php">Informasi Publik</a></li>
            ...
            <a href="login.php" class="btn navbar-btn btn-ghost" >Log in</a>
            </ul>
          </div>
        </div>
      </div>
    ...
    <!--<div id="login-modal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true" class="modal fade">
      <div class="modal-dialog modal-sm">
          ...
          <div class="modal-body">
            <form action="customer-orders.html" method="post">
              <div class="form-group">
                <input id="email_modal" type="text" placeholder="username" class="form-control">
              </div>
              <div class="form-group">
        ...
        <button type="button" class="btn btn-danger"> Lupa Password</button>
              </p>
            </form>
            <p class="text-center text-muted">Belum mendaftar?</p>
            <p class="text-center text-muted"><a href="#"><strong>Daftar disini!</strong></a></p>
          </div>
        </div>
      </div>
    </div> -->
